...
export const SandpackConsole = ({ visible }) => {
  ...
  return (
    <div className="dark:bg-gray-95 absolute bottom-0 w-full border-t bg-white dark:border-gray-700 dark:text-white">
      ...
      {isExpanded && (
        <div className="dark:bg-gray-95 console h-full min-h-[28px] w-full border-t bg-white dark:border-gray-700">
